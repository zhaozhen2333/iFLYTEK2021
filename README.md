# (1/486) The-iFLYTEK-2021-Cultivatedland-Extraction-From-High-Resolution-Remote-Sensing-Image-Challenge
Our code is developed based on the mmdetection. All the our code is in the file "out_shp". If this has been helpful to you, please give me a star or citation, thank you!

Extracting cultivated land accurately from high-resolution remote images is a basic task for precision agriculture. This work introduces our solution to [iFLYTEK challenge 2021 cultivated land extraction from high-resolution remote sensing images](http://challenge.xfyun.cn/topic/info?type=plot-extraction-2021&option=ssgy). We established a highly effective and efficient pipeline to solve this problem. We first divided the original images into small tiles and separately performed instance segmentation on each tile. We explored several instance segmentation algorithms
...
#### Dataset
  ...
  链接: https://pan.baidu.com/s/1GRNGD78hu85Qz4Y9aZEEPw?pwd=star
  提取码: star
